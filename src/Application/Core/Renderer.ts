...
export class Renderer {
    ...
    setInstance() {
        ...
        try {
            ...
            // Режим берём из параметров проекта: у нового это Reinhard, у сохранённого — свой
    ...
    // Принимает константу тонового отображения three.js; неизвестное значение
    // приводится к режиму по умолчанию
