<template>
  <div
    :class="`${type === 'main' ? 'basket-table--height' : ''} basket-table`"
    v-if="items.length || type === 'main'"
  >
    <div v-if="title && items.length" class="basket-table__title">
      {{ title }}
    </div>
    ...
    <p v-if="type === 'main' && !items.length" class="basket-table__none-text">
